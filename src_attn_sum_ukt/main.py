...
def main():
    ...
    decoder = SumDecoder(args.embed_size, args.hidden_size, args.dropout, lang, len(keys_idx), args.key_flag)
    encoderdecoder = EncoderDecoder(args.embed_size, args.hidden_size, len(keys_idx), args.dropout, lang)
